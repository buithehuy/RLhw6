...
import numpy as np
import random
from utils import get_board_size
sizeboard = get_board_size()

class Learner(ABC):
    """
    Parent class for Q-learning
    ...
    def get_action(self, s):
        ...
        possible_actions = [a for a in self.actions if s[a[0]*sizeboard + a[1]] == '-']
...
class Qlearner(Learner):
    ...
    def update(self, s, s_, a, a_, r):
        ...
        if s_ is not None:
            ...
            possible_actions = [action for action in self.actions if s_[action[0]*sizeboard + action[1]] == '-']
