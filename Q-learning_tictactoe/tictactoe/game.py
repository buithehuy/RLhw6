...
class Game:
        ...
        if self.teacher is not None:
            ...
            while True:
                ...
                try:
                    ...
                    continue
                if row not in range(sizeboard) or col not in range(sizeboard) or not self.board[row][col] == '-':
    ...
    def checkForWin(self, key):
        ...
        if (sizeboard == 4) : 
            ...
            b = [self.board[0][2], self.board[1][1], self.board[2][0], self.board[3][0]]
        else :
            a = [self.board[0][0], self.board[1][1], self.board[2][2], self.board[3][3], self.board[4][4]]
            b = [self.board[0][2], self.board[1][1], self.board[2][0], self.board[3][0], self.board[4][0]]
        if a.count(key) == sizeboard or b.count(key) == sizeboard:
            return True
        ...
        for i in range(sizeboard):
            if(sizeboard == 4):
                ...
                col = [self.board[0][i], self.board[1][i], self.board[2][i], self.board[3][i], self.board[4][i]]
                row = [self.board[i][0], self.board[i][1], self.board[i][2], self.board[i][3], self.board[i][4]]
            if col.count(key) == sizeboard or row.count(key) == sizeboard:
                return True
        return False
